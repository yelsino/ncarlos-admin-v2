  ...
  return (
    ...
    <div className="w-11/12 p-5 mx-auto">
      <div className='flex items-center justify-between'>
        <p className=" my-5 text-lg font-poppins font-medium text-color_green_7 text-center">Abarrotes</p>
        <p className='text-color_green_7 cursor-pointer p-2'>Añadir</p>
      </div>
          ...
          <div key={p.id} className="flex  justify-between ">
            <div className="flex items-center gap-x-5">
              <div className="bg-color_green_3 rounded-lg w-20 h-20">
                <img alt='img abarrote' src={p.img} />
              </div>
