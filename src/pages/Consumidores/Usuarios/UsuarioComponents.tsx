...
const UsuarioComponents = () => {
  ...
  return (
    <div className="w-full sm:hidden">
      <div className=" my-5 flex justify-center gap-x-24 text-center">
      ...
      <div className="flex flex-col gap-y-5">
        ...
        >
          ...
          <div>
            ...
            <p className="text-color_green_5 text-sm">
              Registrado el 11/05/2022
            </p>
          </div>
        </Link>
        <Link
          to={`/comprador/usuarios/${userID}/compras`}
          className="flex items-center gap-x-3  p-2"
        >
          <span className="text-color_green_7">
        ...
        <Link
          to={`/comprador/usuarios/${userID}/listas`}
          className="flex items-center gap-x-3  p-2"
        >
          <span className="text-color_green_7">
        ...
        <Link
          to={`/comprador/usuarios/${userID}/direcciones`}
          className="flex items-center gap-x-3  p-2"
        >
          <span className="text-color_green_7">
          ...
          <div>
            ...
            <p className="text-color_green_5 text-sm">
              10 Direcciones registrada
            </p>
          </div>
        </Link>
        <Link
          to={`/comprador/usuarios/${userID}/reclamos`}
          className="flex items-center gap-x-3  p-2"
        >
          <span className="text-color_green_7">
